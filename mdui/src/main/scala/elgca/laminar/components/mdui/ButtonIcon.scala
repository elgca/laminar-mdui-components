...
object ButtonIcon extends WebComponent("mdui-button-icon") {
  ...
  @JSImport("mdui/components/button-icon.js", JSImport.Namespace)
  @js.native object RawImport extends js.Object

  type Self = ButtonIcon.type

  type Ref = ButtonIconComponent & dom.HTMLElement
  ...
  object CommonKeys extends CommonTypes {
    ...
    object variant extends HtmlAttr[String]("variant", StringAsIsCodec) {
      ...
      lazy val standard: HtmlAttrSetter[String] = autoCapitalize("standard")

      lazy val filled: HtmlAttrSetter[String] = autoCapitalize("filled")

      lazy val tonal: HtmlAttrSetter[String] = autoCapitalize("tonal")
  ...
  object slots {
    ...
    /** 图标组件 Note: You can just say `_ => element` instead of `_.slots.default(element)` */
  ...
  @js.native trait ButtonIconComponent extends js.Object { this: dom.HTMLElement => 
