...
/**
  ...
  * ```
  * 
  * [[https://github.com/raquo/laminar-shoelace-components/blob/master/sample/src/main/scala/elgca/laminar/components/mdui/SegmentedButtonGroup.scala SegmentedButtonGroup.scala source code]]
  */
object SegmentedButtonGroup extends WebComponent("mdui-segmented-button-group") {

  @JSImport("@shoelace-style/shoelace/dist/components/segmented-button-group/segmented-button-group.js", JSImport.Namespace)
